	...
	<head>
		...
		<style type="text/css">
                ...
                <?php
                    ...
                    $query = "SELECT ent.tipo,ent.descripcion,COUNT(fam.idfamilia)
                            FROM entorno ent INNER JOIN familia fam ON ent.idfamilia = fam.idfamilia AND ent.claveGeneral=fam.claveGeneral
                            WHERE $campo = '$valor' AND ent.tipo = '$_REQUEST[tipo]' AND fam.activo = 'AC'
		...
		<script type="text/javascript">
                    jQuery(function () {
                        jQuery('#container').highcharts({
                            ...
                            title: {
                                text: 'Reporte n\xFAmero de familia segun vivienda y entorno',
                                style: {
                                        color: '#FF7474',
                                        fontSize: '30px'
                                }
                            ...
                            subtitle: {
                                text: <?php echo "'$_REQUEST[tipo] <br/> $_REQUEST[atributo]: $_REQUEST[seleccion]'";?>
                            },
                            xAxis: {
                                type: 'category',
                                labels: {
