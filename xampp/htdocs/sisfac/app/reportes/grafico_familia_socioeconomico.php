	...
	<head>
		...
		<style type="text/css">
                ...
                <?php
                    ...
                    $query = "SELECT soc.tipo,soc.descripcion,COUNT(fam.idfamilia)
                            FROM socioeconomico soc INNER JOIN familia fam ON soc.idfamilia = fam.idfamilia AND soc.claveGeneral=fam.claveGeneral
                            WHERE $campo = '$valor' AND soc.tipo = '$_REQUEST[tipo]' AND soc.descripcion <> ''  AND fam.activo = 'AC'
		...
		<script type="text/javascript">
                    jQuery(function () {
                        jQuery('#container').highcharts({
                            ...
                            title: {
                            text: "Número de familias según " + <?php echo "'".strtolower($_REQUEST[tipo])."'";?>,
                                style: {
                                        color: '#FF7474',
                                        fontSize: '30px'
                                }
                            ...
                            subtitle: {
                                text: <?php echo "'$_REQUEST[atributo]: $_REQUEST[seleccion]<br/><br/> Reporte al $_REQUEST[fechaFin]'";?>
                            },
                            xAxis: {
                                type: 'category',
                                labels: {
