	...
	<head>
		...
		<style type="text/css">
                ...
                <?php
                    ...
                    $query = "SELECT tipoFamilia as nombreCiclo, COUNT(*) as total FROM (
                                SELECT codigoFicha, claveGeneral, tipoFamilia 
                                FROM familia fam 
                                WHERE fam.activo='AC' and $campo = '$valor'  AND tipoFamilia <>'') AS T GROUP BY 1";
		...
		<script type="text/javascript">
                    jQuery(function () {
                        jQuery('#container').highcharts({
                            ...
                            title: {
                                text: 'Reporte n\xFAmero de familia por tipo',
                                style: {
                                        color: '#FF7474',
                                        fontSize: '30px'
                                }
