	...
	<head>
		...
		<style type="text/css">
                ...
                <?php
                    ...
                    $query = "SELECT nromodifaciones , COUNT(*) as nrofamilias FROM (
                            SELECT codigoFicha, COUNT(*) as nromodifaciones
                            FROM familiaH fam WHERE $campo = '$valor'
                            GROUP BY 1)  AS T GROUP BY 1";
		...
		<script type="text/javascript">
                    jQuery(function () {
                        jQuery('#container').highcharts({
                                ...
                                data: [
                                    <?php
                                        while ($row = mysql_fetch_array($result)) {
                                            echo "['$row[0] <br>modificacion',$row[1]],";
                                        }
                                    ?>
                                ],
                                dataLabels: {
                            ...
                            title: {
                                text: 'Reporte n\xFAmero de modificaciones por familia',
                                style: {
                                        color: '#FF7474',
                                        fontSize: '30px'
                                }
