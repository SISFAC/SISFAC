	...
	<head>
		...
		<style type="text/css">
                ...
                <?php
                    ...
                    $query = "SELECT gradoInstruccion as tipo, COUNT(*) as total FROM (
                                SELECT dni, gradoInstruccion 
                                FROM familia fam INNER JOIN persona per ON fam.idfamilia = per.idfamilia AND fam.claveGeneral=per.claveGeneral 
                                WHERE $campo = '$valor' AND fam.activo = 'AC' AND per.activo = 'AC' AND gradoInstruccion<>''  ) AS T
                                GROUP BY 1";
		...
		<script type="text/javascript">
                    jQuery(function () {
                        jQuery('#container').highcharts({
                            ...
                            title: {
                                text: 'Reporte n\xFAmero de personas por grado de instrucci\xf3n',
                                style: {
                                        color: '#FF7474',
                                        fontSize: '30px'
                                }
