...
$excel = $archivo->load('Reporte_numero_historiales.xlsx');
...
while($rowgen = mysql_fetch_array($resultgen)){
    ...
    $query1 = "SELECT codigoFicha,nombreFamilia, COUNT(*) as nromodifaciones
                FROM familiaH fam where 1=1 $wh 
                group by codigoFicha,nombreFamilia";
...
$nombre = 'HISTORIALES_FAMILIA'.date('d/m/y H:i:s');
