...
$excel = $archivo->load('Reporte_personas_instruccion.xlsx');
global $wh;
...
while($rowgen = mysql_fetch_array($resultgen)){
    $query1 = "SELECT sexo , $_REQUEST[opc] as tipo, COUNT(*) as total FROM (
                SELECT dni,sexo,gradoInstruccion,seguroMedico
