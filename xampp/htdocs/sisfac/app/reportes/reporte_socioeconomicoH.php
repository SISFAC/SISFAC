...
<td align=\"rigth\" valign=\"middle\">
 ...
 <tr>
 <td align=\"center\" colspan=\"3\"><label style=\"font-size:16;\"><b><br/>REPORTE DE DATOS SOCIOECONÓMICOS DE LA FAMILIA</b></label><br/></td>
 </tr>
 <tr>
...
$contenido.= "<table border=\"1\">
                <thead>
                        <tr>
                            <td align=\"center\" width=\"300\">Tipo</td>
                            <td align=\"center\" width=\"350\">Descripci&oacute;n</td>
                            <td width=\"50\" align=\"center\" >Puntaje</td>
                        </tr>
                    </thead>
                    <tbody>
    ";
...
$contenido.= "<tr>
                <td width=\"300\">$row[tipo]</td>
                <td width=\"350\">$row[descripcion]</td>
                <td width=\"50\" align=\"right\" >$row[puntaje]</td>
    </tr>
";
$s += $row[puntaje];
}
$contenido.= "
    <tr><td width=\"650\" align=\"right\" colspan=\"2\" ><b>Total:</b></td>
